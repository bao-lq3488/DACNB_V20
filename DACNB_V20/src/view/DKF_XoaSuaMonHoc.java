...
public class DKF_XoaSuaMonHoc extends JInternalFrame implements ActionListener {
	/**
	 * 
	 */
	...
	private static DKF_XoaSuaMonHoc instance = null;

	public static DKF_XoaSuaMonHoc getInstance() {
		if (instance == null) {
			instance = new DKF_XoaSuaMonHoc();
		}
		return instance;
	}

	private DKF_XoaSuaMonHoc() {
		setSize(320, 230);
