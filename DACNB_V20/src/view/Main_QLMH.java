...
public class Main_QLMH {
	...
	MenuItem quanLy_MH, quanLy_SV, inAn, lietKe_MH, them_MH, xoa_MH, sua_MH,
			xem_MH, capNhat_MH, lietKe_SV, them_SV, xoa_SV, sua_SV, xem_SV,
			capNhatDiem_SV, danhSach_SV, diem_MH, diem_SV;
	...
	public void createUI() {
		...
		them_MH.addListener(SWT.Selection, btn_Them_SV_Clicked());
		...
		lietKe_SV.addListener(SWT.Selection, btn_LietKe_SV_Clicked());
		...
		xoa_SV.setText("&Xoa");
		xoa_SV.addListener(SWT.Selection, btn_Xoa_SV_Clicked());

		sua_SV = new MenuItem(menuQLSV, SWT.PUSH);
		sua_SV.setText("&Sua");
		sua_SV.addListener(SWT.Selection, btn_Sua_SV_Clicked());

		xem_SV = new MenuItem(menuQLSV, SWT.PUSH);
		xem_SV.setText("X&em");
		xem_SV.addListener(SWT.Selection, btn_Xem_SV_Clicked());
	...
	public Listener btn_Xem_SV_Clicked() {
		return new Listener() {
			public void handleEvent(Event arg0) {
				new Form_ThongTinMH(shell);
			}
	...
	public Listener btn_Sua_SV_Clicked() {
		return new Listener() {
			public void handleEvent(Event arg0) {
				new Form_XoaSua(shell);
			}
	...
	public Listener btn_Xoa_SV_Clicked() {
		return new Listener() {
			public void handleEvent(Event arg0) {
				new Form_XoaSua(shell);
			}
	...
	public Listener btn_LietKe_SV_Clicked() {
		return new Listener() {
			public void handleEvent(Event arg0) {
				new Form_LietKe(shell);
			}
